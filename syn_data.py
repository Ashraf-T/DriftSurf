...
def sea_abrupt0():
    ...
    with open('data/moa/sea_abrupt0.arff') as file:
...
def sea_abrupt10():
    ...
    with open('data/moa/sea_abrupt10.arff') as file:
        reader = csv.reader(file, delimiter=',')
        i = 0
        for line in reader:
            features = {}
...
def sea_abrupt20():
    ...
    with open('data/moa/sea_abrupt20.arff') as file:
        reader = csv.reader(file, delimiter=',')
        i = 0
        for line in reader:
            features = {}
...
def sea_abrupt30():
    ...
    with open('data/moa/sea_abrupt30.arff') as file:
        reader = csv.reader(file, delimiter=',')
        i = 0
        for line in reader:
            features = {}
...
WriteStreamToARFFFile -s (ConceptDriftStream -s (generators.SEAGenerator -f 3 -p 10 -b) -d 
    (ConceptDriftStream -s (generators.SEAGenerator -f 2 -p 10 -b) -d 
        (ConceptDriftStream -s (generators.SEAGenerator -f 4 -p 10 -b) -d 
            (generators.SEAGenerator -f 1 -p 10 -b)
        -p 25000 -w 1) 
    -p 25000 -w 1)
